...
<main id="main">
	<header>
		<h1><span><i class="fas fa-balance-scale  fa-lg"></i> </span> Gerichts-<span class="akzent2">Gutachten<span></h1>	 
		<p>Wir schreiben qualifizierte Familienrechtsgutachten in allen familienrechtlichen Fragestellungen. Familienrechtsgutachten werden vom Gericht beauftragt, wir arbeiten hier also nicht für private Auftraggeber.</p>
		<h2><span>Familienrechtspsychologische Gutachten in Familiensachen</span></h2>
	</header>
	
	<article>
		<section class="spalte beratung">
			<h2><a href="kontakt.php"><i class="fas fa-balance-scale  fa-lg"></i> Psychologische Gutachten</a></h2>
			<p>Rechtspsychologie</p>
			<img class="foto" src="img/recht_1_gross.jpg" alt="Rechtsgutachten">
    ...
    <nav id="navigation">
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a aria-current="page"><i class="fas fa-balance-scale fa-fw"></i> Gutachten</a>
