...
<main id="main">
	...
	<section class="spalte beratung">
        ...
        <img class="foto" src="img/beratung_1quadrat.jpg" alt="Psychologische Hilfe">
	...
	<section class="spalte paar-sex">
        ...
        <img class="foto" src="img/paare-sex_1quadrat.jpg" alt="Partnerschaft, Sexualität">
	...
	<section class="spalte online">
        ...
        <img class="foto" src="img/onlineberatung_6bquadrat.jpg" alt="Online-Beratung">
