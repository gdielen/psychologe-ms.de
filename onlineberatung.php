...
<main id="main">
	<header>
		<h1><span><i class="fas fa-laptop fa-lg"></i> </span> Psychologische Hilfe <span class="akzent2">Online</span></h1>	 
		<p>Unsere Online-Beratung bietet Konflikt-Lösungen und Anregungen zur Selbsthilfe zu allen auf unseren Seiten genannten Themen.<br>(Sie ersetzt bei schweren psychischen Störungen allerdings keine Psychotherapie und dient auch nicht zur akuten Krisenintervention.)</p>
		<h2><span>So geht's:</span></h2>		
	</header>
	
	<article>			
		<section class="spalte beratung">
			<h2><a href="https://meet.jit.si/48157<?PHP echo date('Ymd'); ?>1959" target="_blank"><i class="fas fa-laptop fa-fw"></i> Online-Beratung</a></h2>
			<p>Psychologische Hilfe direkt zu Hause</p>
			<img class="foto" src="img/onlineberatung_1_mgross.jpg" alt="Psychologische Hilfe" >
			<p> Wir benötigen von Ihnen zunächst Ihre <a href=kontakt.php><strong>Kontaktdaten</strong></a> (Name, Telefon, eMail), wann Sie am besten erreichbar sind und einige Infos zu Ihrem Anliegen. Wir werden Sie daraufhin zeitnah kontaktieren zwecks Terminabsprache, einschließlich Hinweisen zu Vorgehen und Bezahlung.</p>
			<p> Zum vereinbarten Zeitpunkt starten Sie auf Ihrem PC, Laptop, Tablet oder Smartphone die Online-Beratung mit dem nachfolgenden Button (Installation von Software etc. ist nicht erforderlich). Dies stellt eine (SSL-gesicherte) Audio/Video-Verbindung her. Sie sollten hierfür Ihr Mikrofon und die Kamera freigeben: die Verbindung wird um Ihre Zustimmung bitten.</p>
			<p>Nachdem Sie die Sitzung gestartet und die Zustimmung zu Mikrofon und Kamera gegenen haben klicken Sie bitte ganz unten auf <strong>"Konferenz beitreten"</strong> (also nicht auf: 'App installieren').
